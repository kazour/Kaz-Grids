"""
Kaz Grids — KzGrids Code Generator
...
def _load_core_template(assets_path=None):
    ...
    template_path = base / "kzgrids" / "KzGrids_core.as.template"
...
class CodeGenerator:
    ...
    def _header(self):
        ...
        return f'''// ============================================================================
// KZGRIDS - Generated by Kaz Grids v{self.app_version}
// Generated: {timestamp}
...
def build_grids(
    ...
    """
    Complete build process for KazGrids.swf.
    ...
    Args:
        ...
        output_swf: Path to write final KazGrids.swf
    ...
    try:
        ...
        temp_swf = Path(temp_dir) / "KazGrids.swf"
        ...
        return True, f"KazGrids.swf built successfully ({output_size:,} bytes)"
